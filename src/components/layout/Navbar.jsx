...
const FloatingContact = ({ links }) => {
  ...
  const socials = [
    {
      href: links ? "https://wa.me/" + links.whatsapp : "#",
      color: "#25D366",
      icon: (
        <svg viewBox="0 0 24 24" width="22" height="22" fill="white">
          ...
          <path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.122 1.532 5.853L.057 23.535a.5.5 0 00.608.608l5.757-1.458A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22a9.944 9.944 0 01-5.073-1.387l-.363-.217-3.767.954.972-3.682-.236-.38A9.944 9.944 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
        </svg>
      ),
    },
    {
    ...
    {
      href: links ? "mailto:" + links.email : "#",
      color: "#D44638",
      icon: (
        <svg viewBox="0 0 24 24" width="22" height="22" fill="white">
          <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 010 19.366V5.457c0-.904.732-1.636 1.636-1.636h.749L12 10.55l9.615-6.73h.749A1.636 1.636 0 0124 5.457z" />
        </svg>
      ),
    },
  ];
        ...
        {socials.map((s, i) => (
          <div
            ...
            style={{
              ...
              animation: open
                ? "popIn 0.3s ease " + (i * 0.07) + "s both"
                : "popOut 0.2s ease " + ((3 - i) * 0.05) + "s both",
